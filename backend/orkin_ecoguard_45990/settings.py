"""
Django settings for orkin_ecoguard_45990 project.
...
ROOT_URLCONF = 'orkin_ecoguard_45990.urls'
...
WSGI_APPLICATION = 'orkin_ecoguard_45990.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "orkin_ecoguard_45990 API",
    "DESCRIPTION": "API documentation for orkin_ecoguard_45990 App",
    "VERSION": "v1",
}
